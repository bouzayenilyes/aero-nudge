    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br py-20">
            ...
            <div className="mt-4 flex items-center gap-4">
                ...
                <a href="https://github.com/bouzayenilyes/aero-nudge" target="_blank" className="px-4 py-2 bg-gray-900 text-white rounded hover:bg-blue-600 transition-colors flex items-center">
